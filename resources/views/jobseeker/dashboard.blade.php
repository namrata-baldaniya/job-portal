        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationDropdown">
                ...
                <li class="dropdown-item d-flex justify-content-between align-items-center">
                    ...
                    <form action="{{ route('jobseeker.notifications.delete', $notification->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-link text-danger p-0" aria-label="Delete">
